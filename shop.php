    ...
    <div class="pro_box_cont">
        ...
        ?>
                <form action="" method="post" class="pro_box">
                    <!-- Display Price above image -->
                    <div class="price_tag">
                        <strong>Price:</strong> Rs. <?php echo $fetch_products['price']; ?>/-
                    </div>

                    <img src="./uploaded_img/<?php echo $fetch_products['image']; ?>" alt="">

                    <h3><?php echo $fetch_products['name']; ?></h3>
                    <h5><?php echo $fetch_products['genre']; ?></h5>
                    <h5><?php echo $fetch_products['description']; ?></h5>
